...
const CardPlayButton = ({ id, size = "3rem" }) => {
    ...
    return (
        <button
            className={`cursor-none sm:cursor-pointer shadow-[0_4px_90px_rgba(0,0,0,.5)] rounded-full bg-green grid place-content-center text-black hover:scale-[1.05] transition-transform`}
